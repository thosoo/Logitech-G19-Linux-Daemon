...
#        self.__selectedItem = self.__selectedItem + direction
#        
...
#    
#        try:
#            self.__slideshow = Slideshow(self.__lg19, "logitech/applets/simple_slideshow/pics")
#            self.__lg19.add_applet(self.__slideshow)
#            while True:
#                time.sleep(10)
#        finally:
